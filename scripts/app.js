...
const burgersbtn = document.querySelector(".burger_btn");
...
const popapstock = document.querySelector(".stock");
const promotext = document.querySelector(".promo");
ststus.addEventListener("click", clothesStatus);

function popapLoad() {
  popapstock.classList.add("activpopap");
}
window.onload = popapLoad();
const clothespopup = () => {
  popapstock.classList.remove("activpopap");
};
popapstock.addEventListener("click", clothespopup);
function clothesStatus() {
  ststus.classList.add("closestatus");
}
function promoText (){
	promotext.classList.toggle('colortexttoggle')
}
